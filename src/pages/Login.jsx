...
const Login = () => {
  ...
  const handleSignIn = async () => {
    try {
      if(email.trim() === ''){
        setErroMessage("Enter the Email")
      }else if (password.trim() === ''){
        setErroMessage("Enter the Password")
      }else{
        ...
        <div className="col-span-4 m-10 bg-white my-auto rounded-xl h-3/3">
          ...
          <div className="mx-auto text-center">
            ...
            <button
              ...
              className="w-3/4 bg-black text-white font-bold text-center text-lg rounded-md py-3 mt-10"
            >
              Login
            </button>
